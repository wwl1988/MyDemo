...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawVertical(Canvas c, RecyclerView parent) {
        ...
        final int chilCount = parent.getChildCount();
    ...
    private void deawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int bottom = child.getBottom() - parent.getPaddingBottom();
